...
export default async function SelectedOrdersPage({
  ...
  // Helpful server log for Vercel (view in Function Logs)
  console.log("SelectedOrdersPage ids:", ids);
  ...
  try {
    ...
    console.error("SelectedOrdersPage prisma error:", err);
    ...
    return (
      <div className="p-6">
        ...
        <p className="mt-2 text-red-600">
          Server error loading selected orders. Check Vercel logs.
        </p>
      </div>
    );
  }
