...
export async function POST(req: Request) {
  ...
  const updates = [
    {
      name: "Net of Logs",
      imageUrl: "/products/net.jpg",
      imageAlt: "Net of seasoned logs",
    },
    {
      name: "Bulk Bag of Logs",
      imageUrl: "/products/bulk-bag.jpg",
      imageAlt: "Bulk bag of seasoned logs",
    },
    {
      name: "IBC Crate",
      imageUrl: "/products/ibc-crate.jpg",
      imageAlt: "IBC crate of seasoned logs",
    },
  ];
